""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"   Main Contributor: feitian124 (feitian124) <feitian124@gmail.com>
"   Version: 2.0
"   Created: 2012-01-20
...
" ivim user setting
let g:ivim_user='feitian124' " User name
let g:ivim_email='feitian124@gmail.com' " User email
let g:ivim_github='https://github.com/feitian124' " User github
" ivim UI setting
...
" Load a colorscheme
if count(g:ivim_bundle_groups, 'ui')
    "colorscheme hybrid  "do not use it as it not work well in tmux
    colorscheme desert
else
    colorscheme desert
endif
